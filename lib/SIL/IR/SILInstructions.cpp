...
EndBorrowAndTakeInst::EndBorrowAndTakeInst(SILDebugLocation debugLoc,
                                           SILValue borrow, SILValue address)
    : InstructionBase(debugLoc, borrow->getType()),
      Operands(this, borrow, address) {}
