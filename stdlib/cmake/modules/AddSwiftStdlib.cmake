...
function(add_swift_target_library_single target name)
  ...
  if(SWIFTLIB_SINGLE_TARGET_LIBRARY)
    ...
    set_target_properties("${target}" PROPERTIES
      LIBRARY_OUTPUT_DIRECTORY ${lib_dir}/${output_sub_dir}
      ARCHIVE_OUTPUT_DIRECTORY ${lib_dir}/${output_sub_dir})
    if(SWIFTLIB_SINGLE_SDK STREQUAL WINDOWS AND SWIFTLIB_SINGLE_IS_STDLIB_CORE
        AND libkind STREQUAL SHARED)
      add_custom_command(TARGET ${target} POST_BUILD
        COMMAND ${CMAKE_COMMAND} -E copy_if_different $<TARGET_FILE:${target}> ${lib_dir}/${output_sub_dir})
    endif()

    foreach(config ${CMAKE_CONFIGURATION_TYPES})
      string(TOUPPER ${config} config_upper)
      escape_path_for_xcode("${config}" "${lib_dir}" config_lib_dir)
      set_target_properties(${target} PROPERTIES
