...
// RUN: %target-swift-frontend -parse-as-library -module-name=test -Xllvm -sil-disable-pass=function-signature-optimization -O %s -emit-ir -disable-reflection-metadata > %t/out.txt
