// RUN: %target-swift-frontend %s -O -Xllvm -sil-disable-pass=FunctionSignatureOptimization -module-name=test -emit-sil | %FileCheck %s

// RUN: %empty-directory(%t) 
// RUN: %target-build-swift -wmo -O -Xllvm -sil-disable-pass=FunctionSignatureOptimization -module-name=test %s -o %t/a.out
