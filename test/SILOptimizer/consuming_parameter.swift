// RUN: %target-swift-frontend -c -disable-availability-checking -Xllvm -sil-print-before=ownership-model-eliminator -O -module-name=main -o /dev/null %s 2>&1 | %FileCheck %s
