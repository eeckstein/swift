...
// RUN: %target-build-swift -O -wmo -Xllvm -sil-disable-pass=FunctionSignatureOpts -parse-as-library -cross-module-optimization -emit-module -emit-module-path=%t/Test.swiftmodule -module-name=Test -I%t %S/Inputs/cross-module/cross-module-objc.swift -c -o %t/test.o
...
func testClass() {
  ...
  print(callObjcClassMember(ObjcClass(), 0))
}
