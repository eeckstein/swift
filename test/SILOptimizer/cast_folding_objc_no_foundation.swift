...
// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) -module-name cast_folding_objc_no_foundation -O -Xllvm -sil-print-types -emit-sil -Xllvm -sil-disable-pass=function-signature-optimization %s | %FileCheck %s
