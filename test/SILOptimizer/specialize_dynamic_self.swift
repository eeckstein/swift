...
// RUN: %target-swift-frontend -module-name specialize_dynamic_self -Xllvm -sil-disable-pass=function-signature-optimization -Xllvm -sil-print-types -emit-sil -O -primary-file %s | %FileCheck %s
