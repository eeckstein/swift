// RUN: %target-swift-frontend -module-name specialize_checked_cast_branch -Xllvm -sil-print-types -emit-sil -O -sil-inline-threshold 0 -Xllvm -sil-disable-pass=function-signature-optimization %s -o - | %FileCheck %s
