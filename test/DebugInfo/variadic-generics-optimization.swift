...
// CHECK: debug_value [[S0]], let, name "xs", argno 1, type $(Int32, Int16, Int8), expr op_tuple_fragment:$(Int32, Int16, Int8):0:op_fragment:#Int32._value, {{.*}} scope [[INLINED_ADDER]]
// CHECK: [[S1:%.*]] = struct_extract %1
// CHECK: debug_value [[S1]], let, name "xs", argno 1, type $(Int32, Int16, Int8), expr op_tuple_fragment:$(Int32, Int16, Int8):1:op_fragment:#Int16._value, {{.*}} scope [[INLINED_ADDER]]
// CHECK: [[S2:%.*]] = struct_extract %2
// CHECK: debug_value [[S2]], let, name "xs", argno 1, type $(Int32, Int16, Int8), expr op_tuple_fragment:$(Int32, Int16, Int8):2:op_fragment:#Int8._value, {{.*}} scope [[INLINED_ADDER]]
